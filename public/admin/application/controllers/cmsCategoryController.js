adminApp.controller('cmsCategoryController',function($scope,dataService){

	/****************General Purpose Variable Declaration******************************/ 
	$scope.pageTitle='CMS Category';
	$scope.title='cms_category';
	...
	$scope.datalist.addNew=function(){
		...
		$scope.templateUrl=temUrl+'form/category-form.html';
	}
	/***************** FUNCTION addNew  End **************************************/ 
